...
function scrollUpdate() {
  if (!stopScroll) {
    ...
    if (clonesHeight + scrollPosition >= scrollHeight) {
      ...
      setScrollPosition(scrollHeight - clonesHeight - 100);
      stopScroll = true;
    }
    ...
    skillTags.forEach((tag, index) => {
      ...
      if (tagPos + 135 >= largeArea && tagPos + 135 <= largeArea + 120) {
        tag.style.height = "150px";
        tag.style.width = "70%";
        tag.style.lineHeight = "150px";
        tag.style.boxShadow = "0 0 10px 1px var(--sec-color)";
        ...
        tag.style.lineHeight = "100px";
        tag.style.width = "60%";
        tag.style.boxShadow = "unset";
      }
    });
  }
